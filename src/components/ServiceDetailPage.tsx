...
export default function ServiceDetailPage({ initialServiceId = "dental-implants", onBookClick }: ServiceDetailPageProps) {
  ...
  const activeService =
    ...
    services.find((service) => service.slug === initialServiceId) ||
    services[0];
  ...
  return (
    <>
    <Header />
      <div className="bg-[#fffaf4] pt-24 sm:pt-28" id="service-details-page">
      ...
      <section className="py-12 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <aside className="lg:col-span-4 space-y-3">
            ...
            <div className="bg-white border border-logo-blue-100 p-5 rounded-3xl text-left space-y-3">
